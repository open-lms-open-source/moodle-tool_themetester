...
$row[] = new \core\output\tabobject('tab2',
$url->out(),
'Another tab',
'This is the hover text for tab2'
);

$row[] = new \core\output\tabobject('tab3',
$url->out(),
'Yet Another tab',
'This is the hover text for tab3'
);

$row[] = new \core\output\tabobject('tab4',
$url->out(),
'More tabs',
'This is the hover text for tab4'
);

$row[] = new \core\output\tabobject('tab5',
$url->out(),
'Even more tabs',
...
echo \core\output\html_writer::tag('div', 'This is a div tag directly under the tab bar. Make sure the padding is correct. ' . $loremipsum);
...
$row1 = array(
    new \core\output\tabobject('row1a', $url->out(), 'Activated Row 1 Tab A'),
    new \core\output\tabobject('row1b', $url->out(), 'Row 1 Tab B'),
    new \core\output\tabobject('row1c', $url->out(), 'Disabled Row 1 Tab C'),
);
$row2 = array(
    new \core\output\tabobject('row2a', $url->out(), 'Row 2 Tab A'),
    new \core\output\tabobject('row2b', $url->out(), 'Selected Row 2 Tab B'),
    new \core\output\tabobject('row2c', $url->out(), 'Row 2 Tab C'),
);
$tabs = array();
$tabs[] = $row1;
$tabs[] = $row2;
...
$activated = array('row1a');
print_tabs($tabs, $currenttab, $inactive, $activated);
echo \core\output\html_writer::tag('div', 'This is a div tag directly under a two row tab bar. Make sure the padding is correct. ' . $loremipsum);
...
$row1 = array(
    new \core\output\tabobject('row1a', $url->out(), 'Row 1 Tab A. ' . $longtext),
    new \core\output\tabobject('row1b', $url->out(), 'Row 1 Tab B. ' . $longtext),
    new \core\output\tabobject('row1c', $url->out(), 'Row 1 Tab C. ' . $longtext),
);
$row2 = array(
    new \core\output\tabobject('row2a', $url->out(), 'Row 2 Tab A. ' . $longtext),
    new \core\output\tabobject('row2b', $url->out(), 'Row 2 Tab B. ' . $longtext),
    new \core\output\tabobject('row2c', $url->out(), 'Row 2 Tab C. ' . $longtext),
);
$tabs = array();
$tabs[] = $row1;
$tabs[] = $row2;
...
$activated = array('row1a');
print_tabs($tabs, $currenttab, $inactive, $activated);
echo \core\output\html_writer::tag('div', 'This is a div tag directly under an overflowing two row tab bar. Make sure the padding is correct. ' . $loremipsum);
